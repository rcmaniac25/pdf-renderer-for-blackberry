 ...
 * Version: 1.3
 * Initial Creation: May 10, 2010 6:30:34 PM
 *
...
import com.sun.pdfview.helper.LinkedList;
...
public class FunctionType4 extends PDFFunction
{
    ...
    /**
     * Helper value since BlackBerry does not contain a log for base 10.
     * 
     * <code>Math.log10(x) == MathUtilities.log(x) / MathUtilities.log(10.0)</code>
     * That can be modified to increase performance by removing the division and making log(10) a constant.
     * That comes to <code>MathUtilities.log(x) * (1.0 / MathUtilities.log(10.0))</code>
     */
    private static final double INVERSE_BASE_10 = 1.0 / 2.302585092994046; //MathUtilities.log(10)
    ...
    private void initOperations()
    {
        ...
        if (operationSet == null)
        {
            ...
            operationSet.addElement(new Operation("abs")
            {
            ...
            operationSet.addElement(new Operation("add")
            {
                /**
            ...
            operationSet.addElement(new Operation("atan")
            {
                /**
            ...
            operationSet.addElement(new Operation("ceiling")
            {
                /**
            ...
            operationSet.addElement(new Operation("cvi")
            {
                /**
            ...
            operationSet.addElement(new Operation("cvr") 
            {
                /**
            ...
            operationSet.addElement(new Operation("div")
            {
                /**
            ...
            operationSet.addElement(new Operation("exp")
            {
                /**
            ...
            operationSet.addElement(new Operation("idiv")
            {
                /**
            ...
            operationSet.addElement(new Operation("ln")
            {
                /**
                ...
                void eval()
                {
                    pushDouble(MathUtilities.log(popDouble()));
                }
            });
            operationSet.addElement(new Operation("log")
            {
                /**
                ...
                void eval()
                {
                    pushDouble(MathUtilities.log(popDouble()) * INVERSE_BASE_10);
                }
            });
            operationSet.addElement(new Operation("mod")
            {
                /**
            ...
            operationSet.addElement(new Operation("mul")
            {
                /**
            ...
            operationSet.addElement(new Operation("neg")
            {
                /**
            ...
            operationSet.addElement(new Operation("round")
            {
                /**
            ...
            operationSet.addElement(new Operation("sqrt")
            {
                /**
            ...
            operationSet.addElement(new Operation("sub")
            {
                /**
            ...
            operationSet.addElement(new Operation("truncate")
            {
                /**
            ...
            operationSet.addElement(new Operation("and")
            {
                /**
            ...
            operationSet.addElement(new Operation("bitshift")
            {
                /**
            ...
            operationSet.addElement(new Operation("eq")
            {
                /**
            ...
            operationSet.addElement(new Operation("false")
            {
                /**
            ...
            operationSet.addElement(new Operation("ge")
            {
                /**
            ...
            operationSet.addElement(new Operation("gt") 
            {
                /**
            ...
            operationSet.addElement(new Operation("le")
            {
                /**
            ...
            operationSet.addElement(new Operation("lt")
            {
                /**
            ...
            operationSet.addElement(new Operation("ne")
            {
                /**
            ...
            operationSet.addElement(new Operation("not")
            {
                /**
            ...
            operationSet.addElement(new Operation("or")
            {
                /**
            ...
            operationSet.addElement(new Operation("true")
            {
                /**
                 * <b>true</b> <i>true</i> <p>
                 *
            ...
            operationSet.addElement(new Operation("xor")
            {
                /**
            ...
            operationSet.addElement(new Operation("if") 
            {
                /**
            ...
            operationSet.addElement(new Operation("ifelse")
            {
                /**
...
//                        expression.push(popExpression());
            ...
            // Stack Operators
            operationSet.addElement(new Operation("copy")
            {
                /**
...
// ????
            ...
            operationSet.addElement(new Operation("dup")
            {
                /**
            ...
            operationSet.addElement(new Operation("exch")
            {
            	/**
            ...
            operationSet.addElement(new Operation("index")
            {
            	/**
            ...
            operationSet.addElement(new Operation("pop")
            {
            	/**
            	 * discard top element
            	 */
            ...
            operationSet.addElement(new Operation("roll")
            {
            	/**
    ...
    /**
     * <p>parse the postscript operators and arguments from the stream.</p>
     *
