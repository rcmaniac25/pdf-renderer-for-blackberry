/*
 * File: GlyfSimple.java
 * Version: 1.2
 * Initial Creation: May 19, 2010 1:41:16 PM
 *
...
public class GlyfSimple extends Glyf
{
    ...
    public void setData(ByteBuffer data)
    {
    	...
    	int len;
        short[] contourEndPts = new short[len = getNumContours()];
        for (int i = 0; i < len; i++)
        {
        ...
        short[] xCoords = new short[len = numPoints];
        for (int i = 0; i < len; i++)
        {
             if (i > 0)
             {
        ...
        short[] yCoords = new short[len = numPoints];
        for (int i = 0; i < len; i++)
        {
            if (i > 0)
            {
    ...
    public ByteBuffer getData()
    {
        ...
        buf.putShort((short)(len = getNumInstructions()));
        for (int i = 0; i < len; i++)
        {
