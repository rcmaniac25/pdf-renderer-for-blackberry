 ...
 * File: HmtxTable.java
 * Version: 1.3
 * Initial Creation: May 19, 2010 4:37:36 PM
 *
...
public class HmtxTable extends TrueTypeTable
{
    ...
    public ByteBuffer getData()
    {
        ...
        // write the metrics
        int len = leftSideBearings.length;
        for (int i = 0; i < len; i++)
        {
    ...
    public void setData(ByteBuffer data)
    {
        ...
        for (i = 0; i < len && data.hasRemaining(); i++)
        {
            if (i < advanceWidths.length)
            {
        ...
        // Initialize the remaining advanceWidths and leftSideBearings to 0
        if (i < advanceWidths.length)
        {
        	Arrays.fill(advanceWidths, (short)0, i, advanceWidths.length - 1 - i);
        }
        if (i < len)
        {
        	Arrays.fill(leftSideBearings, (short)0, i, len - 1 - i);
        }
    }
