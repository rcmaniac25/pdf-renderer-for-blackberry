 ...
 * Version: 1.3
 * Initial Creation: May 18, 2010 9:03:58 PM
 *
...
public class CMapFormat4 extends CMap
{
    ...
    protected CMapFormat4(short language)
    {
        ...
        segments = PDFUtil.synchronizedTable(new Hashtable());
    ...
    public short getLength()
    {
        ...
        for (Enumeration i = segments.keys(); i.hasMoreElements();)
        {
            Segment s = (Segment)i.nextElement();
...
//#endif
    ...
    public short getEntrySelector()
    {
        ...
        return (short) (MathUtilities.log(sr2) / MathUtilities.log(2));
    }
...
//#endif
    {
        ...
        public int compareTo(Object o)
        {
            ...
            if (((s.endCode >= startCode) && (s.endCode <= endCode)) || ((s.startCode >= startCode) && (s.startCode <= endCode)))
            {
                return 0;
            }
