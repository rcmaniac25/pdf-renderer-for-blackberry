/*
 * File: BuiltinFont.java
 * Version: 1.4
 * Initial Creation: May 15, 2010 10:38:46 PM
 *
...
public class BuiltinFont extends Type1Font
{
    ...
    public BuiltinFont(String baseFont, PDFObject fontObj, PDFFontDescriptor descriptor) throws IOException
    {
        ...
        if ((descriptor.getItalicAngle() != 0) || ((flags & (PDFFontDescriptor.SCRIPT | PDFFontDescriptor.ITALIC)) != 0))
        {
            style |= Font.ITALIC;
        }
