...
public class Type1Font extends OutlineFont
{
    ...
    protected void parseFont(byte[] font, int start, int len)
    {
        ...
        Hashtable tab = readChars(data);
        name2outline = new Hashtable();
        PDFUtil.Hashtable_putAll(name2outline, tab);
    ...
    {
        // each byte of output is derived from one character (two bytes) of input
     ...
     * decoded font data.
     */
    private Hashtable readChars(byte[] d)
    {
