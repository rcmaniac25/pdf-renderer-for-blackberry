 ...
 * File: PDFFont.java
 * Version: 1.6
 * Initial Creation: May 15, 2010 11:00:56 AM
 *
...
public abstract class PDFFont
{
     ...
     */
    public synchronized static PDFFont getFont(PDFObject obj, Hashtable resources) throws IOException
    {
...
//            throw new IOException ("CIDFontType0 is unimplemented. " + obj);
     ...
     */
    public Vector getGlyphs(String text)
    {
    	Vector outList = null;
        ...
        else
        {
            ...
            int len;
            outList = new Vector(len = arry.length);

            for (int i = 0; i < len; i++)
            {
                // only look at 2 bytes when there is no encoding
                char src = (char)(arry[i] & 0xff);
                outList.addElement(getCachedGlyph(src, null));
            }
        }
