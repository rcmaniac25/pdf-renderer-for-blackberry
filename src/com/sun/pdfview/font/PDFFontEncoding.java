 ...
 * Version: 1.4
 * Initial Creation: May 15, 2010 12:43:08 PM
 *
...
public class PDFFontEncoding
{
    ...
    public Vector getGlyphs(PDFFont font, String text)
    {
    	Vector outList = new Vector(text.length());
        ...
        for (int i = 0; i < len; i++)
        {
            ...
            {
                case TYPE_ENCODING:
                    outList.addElement(getGlyphFromEncoding(font, arry[i]));
                    break;
                case TYPE_CMAP:
                    ...
                    outList.addElement(getGlyphFromCMap(font, c));
                    break;
            }
        }
