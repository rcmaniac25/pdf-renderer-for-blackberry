 ...
 * File: HeadTable.java
 * Version: 1.3
 * Initial Creation: May 18, 2010 9:31:46 PM
 *
...
public class HeadTable extends TrueTypeTable
{
    ...
    public void setData(ByteBuffer data)
    {
        ...
        setCreated(PDFUtil.ByteBuffer_getLong(data));
        setModified(PDFUtil.ByteBuffer_getLong(data));
    ...
    public ByteBuffer getData()
    {
        ...
        PDFUtil.ByteBuffer_putLong(buf, getCreated());
        PDFUtil.ByteBuffer_putLong(buf, getModified());
